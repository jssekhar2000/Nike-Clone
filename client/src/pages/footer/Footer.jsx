...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Sekhar Mohanta</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://devbysekhar.vercel.app/"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/jssekhar2000/"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/sekhar-mohanta-12ab48234/"}
                    />
                </Flex>
